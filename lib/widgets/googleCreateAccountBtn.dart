...
class GoogleCreateAccountButton extends StatelessWidget {
                  ...
                  onPressed: () async {
                    try {
                      ...
                      if (!res){
                        ...
                        Fluttertoast.showToast(msg: "Gmail Account Authentication...");
                        _navigationService.navigateTo(CompleteProfileRoute);
                      }
